...
public class ParentMakerKCWrapper {
    ...
    public final byte[] natParentService;
    ...
    public ParentMakerKCWrapper(KConfigCore configCore) {
        ...
        this.globalCroupier = Ints.toByteArray(KConfigHelper.read(configCore, ParentMakerKConfig.globalCroupier));
        this.natParentService = Ints.toByteArray(KConfigHelper.read(configCore, ParentMakerKConfig.natParentService));
    }
}
