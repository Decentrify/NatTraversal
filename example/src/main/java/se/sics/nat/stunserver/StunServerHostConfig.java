...
import se.sics.nat.stun.server.StunServerConfig;
...
public class StunServerHostConfig implements KConfigLevel {
    public final static OpenAddressBootstrapOption bootstrap = new OpenAddressBootstrapOption("stun.server.bootstrap", new StunServerConfig());
