...
public class SimpleNatMngrComp extends ComponentDefinition {
  ...
  private void setNatDetection() {
    ...
    natDetectionChannels[0] = connect(natDetectionComp.getNegative(NxNetPort.class), nxNetComp.getPositive(
      NxNetPort.class), Channel.TWO_WAY);
    natDetectionChannels[1] = connect(natDetectionComp.getPositive(NatDetectionPort.class), natDetectionPort.getPair(),
      Channel.TWO_WAY);
