...
public class NatDetectionComp extends ComponentDefinition {
    ...
    private void setupStunClient1() {
        ...
        stun2BindReq = new NxNetBind.Request(stunAdr2);
    ...
    private void setStunClient() {
        Component stunClientComp = create(StunClientComp.class, new StunClientComp.Init(stunAdr, natDetectionConfig.stunView));
        ...
        stunClientChannels[2] = connect(stunClientComp.getPositive(StunClientPort.class), stunPort.getPair(), Channel.TWO_WAY);
