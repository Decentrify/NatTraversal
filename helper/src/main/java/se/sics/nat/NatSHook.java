...
// */
//public class NatSHook {
//
//    private Logger LOG = LoggerFactory.getLogger(NatSHook.class);
...
//
//    public NatSHook(ComponentProxy proxy, NatSetupHP parent, SystemHookSetup systemHooks,
//            NatSetupInit init) {
//        this.proxy = proxy;
//        this.parent = parent;
//        this.systemHooks = systemHooks;
//        Optional<String> missingHook = systemHooks.missingHook(NatSetupHooks.values());
...
//                NatSetupHooks.NAT_ADDRESS_SOLVER.toString(),
