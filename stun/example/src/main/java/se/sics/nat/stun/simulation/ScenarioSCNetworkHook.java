 ...
 */
public class ScenarioSCNetworkHook implements SCNetworkHook.Definition {

    private Positive<Network> network = null;

    @Override
    public SCNetworkHook.SetupResult setup(ComponentProxy proxy, SCNetworkHook.SetupInit setupInit) {
        if (network == null) {
