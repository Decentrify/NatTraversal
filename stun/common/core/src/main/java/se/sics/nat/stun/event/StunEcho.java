...
public abstract class StunEcho implements StunEvent {
    ...
    public static class Request extends StunEcho {
        ...
        public Request(Identifier eventId, Identifier sessionId, Type type, NatAwareAddress target) {
            super(eventId, sessionId, type);
            this.target = target;
        }

        public Request(Identifier sessionId, Type type, NatAwareAddress target) {
            this(BasicIdentifiers.eventId(), sessionId, type, target);
        }

        public Response answer(KAddress src) {
            return new Response(eventId, sessionId, type, Optional.of(src));
        }

        public Response answer() {
            return new Response(eventId, sessionId, type, Optional.absent());
        }

        public Reset reset() {
            return new Reset(eventId, sessionId, type);
        }

        @Override
        public String toString() {
            return "StunEchoReq<" + sessionId + ", " + type.toString() + ", " + eventId + ">";
        }
    ...
    public static class Response extends StunEcho {
        ...
        @Override
        public String toString() {
            return "StunEchoResp<" + sessionId + ", " + type.toString() + ", " + eventId + ">";
        }
    ...
    public static class Reset extends StunEcho {
        ...
        public Reset(Identifier id, Identifier sessionId, Type type) {
            super(id, sessionId, type);
        }

        @Override
        public String toString() {
            return "StunEchoReset<" + sessionId + ", " + type.toString() + ", " + eventId + ">";
        }
